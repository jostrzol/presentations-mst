...
\begin{frame}
	...
	\begin{enumerate}
		\item {\color{gray} Implementacja programów przykładowych (w wersji z
		      systemem operacyjnym):} \label{item:tasks-no-os}
		      \begin{enumerate}[A]
			      \setcounter{enumii}{2}
			      \item \textbf{marzec:} {\color{gray}regulacja PID obrotów
				            silnika z komunikacją protokołem \Modbus{}} (\CLogo{},
			            \ZigLogo{}),
