...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[height=0.8\textheight]{img/plots/metrics/3-pid-bm.pdf}
		\centering
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{\dimexpr\paperwidth-10pt}
			\begin{figure}
				\includegraphics[width=\linewidth]{img/plots/metrics/3-pid-bm-perf.pdf}
				\centering
...
\begin{frame}
	...
	\begin{itemize}
		\item mniej podatne na błędy niż \CLogo{}
