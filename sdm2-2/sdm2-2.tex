...
\begin{frame}
	\frametitle{Problemy z \CLogo{}}

	\begin{columns}
		\column{\dimexpr\paperwidth-10pt}
		\begin{figure}
			\includegraphics[width=\linewidth]{img/plots/top-tags-c.pdf}
			\caption{Najpopularniejsze tagi zapytań z serwisu StackOverflow dla języka \C{}}
			\centering
		\end{figure}
	\end{columns}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Makra
		\item System budowania, menadżer pakietów
		\item Obsłga błedów
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			...
			\caption{Najpopularniejsze tagi zapytań z serwisu StackOverflow dla języka \Rust{}}
			\centering
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			...
			\caption{Najpopularniejsze tagi zapytań z serwisu StackOverflow dla języka \Zig{}}
			\centering
		\end{figure}
	\end{columns}
\end{frame}
